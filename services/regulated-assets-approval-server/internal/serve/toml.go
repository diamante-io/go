...
type diamcircleTOMLHandler struct {
	assetCode         string
...
func (h diamcircleTOMLHandler) validate() error {
...
func (h diamcircleTOMLHandler) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
