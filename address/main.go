// Package address provides utility functions for working with diamcircle
// addresses. See https://developers.diamcircle.org/docs/glossary/federation/
// html#diamcircle-addresses for more on addresses.
package address
