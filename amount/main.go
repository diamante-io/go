...
// the format used internally to diamcircle-core.
//
// diamcircle-core represents asset "amounts" as 64-bit integers, but to enable
// fractional units of an asset, aurora, the client-libraries and other built
// on top of diamcircle-core use a convention, encoding amounts as a string of
...
// represented in diamcircle-core as 1010010000.
package amount
...
// One is the value of one whole unit of currency. diamcircle uses 7 fixed digits
...
var (
	...
	// Note: {1,20} because the biggest amount you can use in diamcircle is:
...
// Parse parses the provided as a diamcircle "amount", i.e. a 64-bit signed integer
...
// ParseInt64 parses the provided as a diamcircle "amount", i.e. a 64-bit signed
...
// IntStringToAmount converts string integer value and converts it to diamcircle
