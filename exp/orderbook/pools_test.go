...
// pool calculation functions are correct, taken from Diamcircle Core's tests here:
//
// https://github.com/diamcircle/diamcircle-core/blob/master/src/transactions/test/ExchangeTests.cpp#L948
