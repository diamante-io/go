...
// This is a build script that Travis uses to build Diamcircle release packages.
...
func build(pkg, dest, version, buildOS, buildArch string) {
	...
	versionFlag := fmt.Sprintf(
		"-X=github.com/diamcircle/go/support/app.version=%s-%s",
		versionString, rev,
	)
...
func repoName() string {
	...
	return "github.com/diamcircle/go"
