...
import (
	...
	"github.com/diamcircle/go/support/test"
...
func TestRender(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			P{Extras: map[string]interface{}{"hello": "diamcircle"}, Status: 500},
			[]string{"hello", "diamcircle"},
			500,
		},
	}
...
func TestInflate(t *testing.T) {
	testCase := struct {
		...
		"renders the type correctly",
		P{Type: "https://diamcircle.org/aurora-errors/not_found", Status: 404},
		"https://diamcircle.org/aurora-errors/not_found",
	}
