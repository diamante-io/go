...
import (
	...
	xdr3 "github.com/diamcircle/go-xdr/xdr3"
...
//
//   * Decouples buffering from diamcircleCoreRunner so it can focus on running core.
//   * Decouples unmarshalling and buffering of LedgerCloseMeta's from CaptiveCore.
//   * By adding buffering it allows unmarshaling the ledgers available in diamcircle-Core
...
// when diamcircle-core terminates.
