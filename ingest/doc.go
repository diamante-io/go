...
Ledger backends are sources of information about Diamcircle network ledgers. This
can be, for example: a Diamcircle-Core database, (possibly-remote) Captive
Diamcircle-Core instances, or History Archives. Please consult the "ledgerbackend"
...
guide: https://github.com/diamcircle/go/blob/master/ingest/README.md
