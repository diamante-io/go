...
This library provides an interface to the diamcircle aurora service. It supports the building of Go applications on
top of the diamcircle network (https://www.diamcircle.org/). Transactions may be constructed using the sister package to
this one, txnbuild (https://go/tree/master/txnbuild), and then submitted with this client to any
aurora instance for processing onto the ledger. Together, these two libraries provide a complete diamcircle SDK.
...
const (
	...
	// AssetTypeNative represents the asset type for diamcircle Lumens (XLM)
...
// Client struct contains data for creating a aurora client that connects to the diamcircle network.
type Client struct {
...
var DefaultTestNetClient = &Client{
	auroraURL:     "https://diamtestnet.diamcircle.io/", //"https://diamtestnet.diamcircle.io/", //"http://54.183.104.16:8000/", //
...
var DefaultPublicNetClient = &Client{
	auroraURL:     "https://mainnet.diamcircle.io/",
	HTTP:          http.DefaultClient,
	auroraTimeout: auroraTimeout,
}

var MudraTestNetClient = &Client{
	auroraURL:     "http://13.57.80.49:8000/",
	HTTP:          http.DefaultClient,
	auroraTimeout: auroraTimeout,
}
...
// See https://developers.diamcircle.org/api/aggregations/paths/strict-receive/
...
// See https://developers.diamcircle.org/api/aggregations/paths/strict-send/
