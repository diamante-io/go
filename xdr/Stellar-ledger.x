// Copyright 2015 diamcircle Development Foundation and contributors. Licensed
// under the Apache License, Version 2.0. See the COPYING file at the root
// of this distribution or at http://www.apache.org/licenses/LICENSE-2.0

%#include "xdr/diamcircle-SCP.h"
%#include "xdr/diamcircle-transaction.h"

namespace diamcircle
{
...
/* diamcircleValue is the value used by SCP to reach consensus on a given ledger
 */
...
/* Ledger upgrades
note that the `upgrades` field from diamcircleValue is normalized such that
