...
// https://github.com/diamcircle/diamcircle-protocol/pull/313
...
func BuildAssets(s string) ([]Asset, error) {
	...
	for _, assetString := range assetStrings {
		...
		// Technically https://github.com/diamcircle/diamcircle-protocol/blob/master/ecosystem/sep-0011.md allows
