...
func (r *RevokeSponsorship) Validate(withMuxedAccounts bool) error {
	...
	case RevokeSponsorshipTypeAccount:
		...
		return validatediamcirclePublicKey(*r.Account)
	case RevokeSponsorshipTypeTrustLine:
		if r.TrustLine == nil {
			return errors.New("Trustline can't be nil")
		}
		if err := validatediamcirclePublicKey(r.TrustLine.Account); err != nil {
			return errors.Wrap(err, "invalid Account address")
		}
		if err := validatediamcircleAsset(r.TrustLine.Asset); err != nil {
	...
	case RevokeSponsorshipTypeOffer:
		...
		if err := validatediamcirclePublicKey(r.Offer.SellerAccountAddress); err != nil {
			return errors.Wrap(err, "invalid Seller account address")
		}
		return validatediamcirclePublicKey(r.Offer.SellerAccountAddress)
	case RevokeSponsorshipTypeData:
		if r.Data == nil {
			return errors.New("Data can't be nil")
		}
		if err := validatediamcirclePublicKey(r.Data.Account); err != nil {
			return errors.Wrap(err, "invalid Account address")
		}
	case RevokeSponsorshipTypeClaimableBalance:
		if r.ClaimableBalance == nil {
	...
	case RevokeSponsorshipTypeSigner:
		...
		if err := validatediamcirclePublicKey(r.Signer.AccountID); err != nil {
			return errors.New("invalid Account address")
		}
		if err := validatediamcircleSignerKey(r.Signer.SignerAddress); err != nil {
