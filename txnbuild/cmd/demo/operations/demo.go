// Package demo is an interactive demonstration of the Go SDK using the Diamcircle TestNet.
package demo
...
// Account represents a Diamcircle account for this demo.
type Account struct {
...
func Reset(client *auroraclient.Client, keys []Account) {
	...
	for _, k := range keys {
		...
		// See https://developers.diamcircle.org/docs/glossary/ledger/#ledger-entries
