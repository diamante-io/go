...
// SetOptions represents the Diamcircle set options operation. See
...
// See https://developers.diamcircle.org/docs/glossary/accounts/#flags
...
// See https://developers.diamcircle.org/docs/glossary/multisig/
...
// https://developers.diamcircle.org/docs/glossary/federation/
...
func (so *SetOptions) Validate(withMuxedAccounts bool) error {
	...
	// Refactoring is out of the scope of this issue(https://github.com/diamcircle/go/issues/1041) so will leave as is for now.
	return nil
}
