...
// TrustLineAsset represents a Diamcircle trust line asset.
...
// LiquidityPoolShareTrustLineAsset represents shares in a liquidity pool on the Diamcircle network.
