...
// PathPayment represents the diamcircle path_payment operation. This operation was removed
// in diamcircle Protocol 12 and replaced by PathPaymentStrictReceive.
...
// PathPaymentStrictReceive represents the diamcircle path_payment_strict_receive operation. See
...
func (pp *PathPaymentStrictReceive) Validate(withMuxedAccounts bool) error {
	...
	err = validatediamcircleAsset(pp.SendAsset)
	if err != nil {
		return NewValidationError("SendAsset", err.Error())
	}

	err = validatediamcircleAsset(pp.DestAsset)
	if err != nil {
