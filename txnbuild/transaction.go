...
programmers is auroraclient (https://go/tree/master/clients/auroraclient). Together, these two
libraries provide a complete diamcircle SDK.
For more information and further examples, see https://go/blob/master/docs/reference/readme.md
*/
package txnbuild
