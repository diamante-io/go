/*
Package txnbuild implements transactions and operations on the Diamcircle network.
This library provides an interface to the Diamcircle transaction model. It supports the building of Go applications on
top of the Diamcircle network (https://www.diamcircle.org/). Transactions constructed by this library may be submitted
to any Aurora instance for processing onto the ledger, using any Diamcircle SDK client. The recommended client for Go
programmers is auroraclient (https://github.com/diamcircle/go/tree/master/clients/auroraclient). Together, these two
libraries provide a complete Diamcircle SDK.
For more information and further examples, see https://github.com/diamcircle/go/blob/master/docs/reference/readme.md
*/
package txnbuild
...
// MinBaseFee is the minimum transaction fee for the Diamcircle network of 100 stroops (0.00001 XLM).
const MinBaseFee = 100

// Account represents the aspects of a Diamcircle account necessary to construct transactions. See
// https://developers.diamcircle.org/docs/glossary/accounts/
...
func stringsToKP(keys ...string) ([]*keypair.Full, error) {
	...
	for _, k := range keys {
		...
		if err != nil {
			return nil, errors.Wrapf(err, "provided string %s is not a valid Diamcircle key", k)
		}
		kpf, ok := kp.(*keypair.Full)
		if !ok {
			return nil, errors.New("provided string %s is not a valid Diamcircle secret key")
		}
...
// Transaction represents a Diamcircle transaction. See
// https://developers.diamcircle.org/docs/glossary/transactions/
...
// See description here: https://developers.diamcircle.org/docs/glossary/multisig/#hashx
...
func (t *Transaction) ClaimableBalanceID(operationIndex int) (string, error) {
	...
	// We mimic the relevant code from Diamcircle Core
	// https://github.com/diamcircle/diamcircle-core/blob/9f3cc04e6ec02c38974c42545a86cdc79809252b/src/test/TestAccount.cpp#L285
	//
...
// More details on SEP 10: https://github.com/diamcircle/diamcircle-protocol/blob/master/ecosystem/sep-0010.md
func BuildChallengeTx(serverSignerSecret, clientAccountID, webAuthDomain, homeDomain, network string, timebound time.Duration) (*Transaction, error) {
	...
	// https://github.com/diamcircle/diamcircle-protocol/blob/master/ecosystem/sep-0010.md#response
...
// verifyTxSignature checks if a transaction has been signed by the provided Diamcircle account.
