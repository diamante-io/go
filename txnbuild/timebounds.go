...
// Timebounds represents the time window during which a Diamcircle transaction is considered valid.
//
// MinTime and MaxTime represent Diamcircle timebounds - a window of time over which the Transaction will be
