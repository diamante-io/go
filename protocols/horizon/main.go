...
// GetAccountID returns the diamcircle account ID. This is to satisfy the
...
type Root struct {
	...
	diamcircleCoreVersion        string    `json:"core_version"`
...
// To do: implement fee suggestions if agreement is reached in https://go/issues/926
